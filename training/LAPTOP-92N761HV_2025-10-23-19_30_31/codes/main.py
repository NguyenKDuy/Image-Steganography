...
def test(test_loader, epoch, Hnet, Rnet, criterion):
    ...
    for i, data in enumerate(test_loader, 0):
        ...
        for j in range(this_batch_size):
            ...
            h_ssim = ssim(cover_np[j].transpose(1,2,0), container_np[j].transpose(1,2,0), multichannel=True, data_range=1.0)
            ...
            r_ssim = ssim(secret_np[j].transpose(1,2,0), rev_secret_np[j].transpose(1,2,0), multichannel=True, data_range=1.0)
